...
const modelOptions = [
  ...
  {
    text: "Human disease idiopatic pulmonary fibrosis",
    value: "human-disease-idiopaticpulmonaryfibrosis",
  },
        ...
        >
          <template #tooltip>
            <div>
              ...
              Choose a pre-trained CellTypist model for cell type annotation. The model contains
              learned gene expression patterns for different cell types.<br /><br />
              <strong>Model types:</strong><br />
              • <strong>Human models:</strong> Immune, brain regions, organs, and disease-specific
              models<br />
        ...
        >
          <template #tooltip>
            <div>
              ...
              <strong>Best match:</strong> Assigns the cell type with the highest confidence score.
              Faster and suitable for most datasets.<br /><br />
              <strong>Majority voting:</strong> Uses ensemble prediction from multiple models for
              more robust annotation. Slower but more accurate for complex tissues.<br /><br />
              <strong>Recommendation:</strong> Use "Best match" for most datasets, "Majority voting"
              for complex tissues or when accuracy is critical.
            </div>
          </template>
        </PlBtnGroup>
        <!-- <PlRow>
