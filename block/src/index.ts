...
export type CellTypeAnnotationBlockContract = BlockContract;
export type CellTypeAnnotationBlockOutputs  = BlockOutputs;
export type CellTypeAnnotationBlockData     = BlockData;
export const CellTypeAnnotationBlockPointer = BlockPointer;
